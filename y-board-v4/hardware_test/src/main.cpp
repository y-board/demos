...
void setup() {
    ...
    if (sw1) {
        ...
        Yboard.display.fillRoundRect(SWITCH_X + PADDING, SWITCH_Y + PADDING + SWITCH_HEIGHT / 2, 8,
                                     8, 3, ON);
    }
    Yboard.display.drawRoundRect(SWITCH_X + SWITCH_WIDTH + PADDING, SWITCH_Y, SWITCH_WIDTH,
                                 SWITCH_HEIGHT, 3, ON);
    if (sw2) {
        Yboard.display.fillRoundRect(SWITCH_X + SWITCH_WIDTH + PADDING * 2, SWITCH_Y + PADDING, 8,
                                     8, 3, ON);
    } else {
    ...
    if (but1) {
        Yboard.display.fillCircle(BUTTON_X + BUTTON_WIDTH / 2, BUTTON_Y + BUTTON_HEIGHT / 2 - 1, 6,
                                  ON);
    } else {
